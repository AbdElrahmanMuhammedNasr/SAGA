...
* The original package name 'com.example.event-driven' is invalid and this project uses 'com.example.eventdriven' instead.
...
```
$ docker run --rm -p 8080:8080 event-driven:0.0.1-SNAPSHOT
```
